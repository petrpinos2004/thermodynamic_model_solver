...
file = 'simulation_results_h432_kappa_my2'

sweep, parametric_sweep, studies, header,modulation, date, is_cartesian, criterion = SULTAN.starting_procedure(f"{file}.txt")
print(modulation)
...
with open(f"{file}_output.csv", "w") as f:
...
print(f'Data succesfully stored in {file}_output.csv')
